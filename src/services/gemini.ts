...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    INSTRUÇÕES: 
    - Use apenas infromações contidas no contexto enviado, adicione pequenos (realmente mínimos) detalhes para complementar a resposta de acordo com o seu conhecimento;
    - Se nada da resposta não for encontrada no contexto, apenas responda que não possui informações suficientes para responder;
    - Seja objetivo
    - Mantenha um tom educativo e profissional;
    - Cite trechos relevantes do contexto se julgar apropriado;
